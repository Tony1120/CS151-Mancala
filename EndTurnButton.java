...
public class EndTurnButton extends JButton implements ChangeListener
{
    ...
    /**
     * Controls when the button is active. 
     * Checks the changed event to check if the button can be used. 
     * @param arg0 is the change event 
     */
    @Override
    public void stateChanged(ChangeEvent arg0) {
        // TODO Auto-generated method stub
        if(dataModel.getStillMyTurn() == true) //when you still have turns, you cannot end the turn
        {
            setEnabled(false);
        }
        else
        {
            setEnabled(true); //when you are out of turns you need to click the button
        }
    }
