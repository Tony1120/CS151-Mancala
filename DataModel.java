...
/**
 * Models the Model in MVC - stores the data for the program and provides accessors and mutators
 *
 */
public class DataModel
{
     ...
     * @param pitIndex is the index of the pit - the pits are in an ArrayList structure
     */
     ...
     * @return int is the code for whether the game is over and who gets to add the stones to their mancala if it is over
     */
    ...
    /**
     * Resets the redo counter back to zero when it's the next person's turn because each turn can have up to 3 redos.
     */
    ...
    /**
     * Increases the redo counter because a player can only redo up to 3 times per turn.
     */
...
//        notifyListeners(); do we need this?
    ...
    /**
     * Updates the "previous" state in case a redo is called - it would have the most previous state saved.
     */
     ...
     * @return stillMyTurn is a boolean saying if it is still the current player's turn or not
     */
     ...
     * @return oldState is an ArrayList of Integers of the most current previous state 
     */
     ...
     * @return redoCounter is the int counting how many redos have happened for the current turn
     */
     ...
     * @param redoCounter is the int counting how many redos have happened for the current turn
     */
